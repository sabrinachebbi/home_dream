...
<body>
  ...
  <div class="form-group">
      ...
      <option value="<?php echo $annonce['transaction_type'] 
      
      ; ?>" >Rent</option>
  <option value="<?php echo $annonce['transaction_type']; ?>">Sale</option>
  </select>
  </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input  id="chambres" name="details1" placeholder="Entrez votre choix" value="<?php echo $annonce['details1']; ?>">
    </div>
    <div class="form-group">
      <label for="chambres">Number of Bathrooms:</label><br>
      <input  id="chambres" name="details2" placeholder="Entrez votre choix" value="<?php echo $annonce['details2']; ?>">
    </div>
    <div class="form-group">
      <label for="prix">Price (in euros):</label><br>
      <input  id="prix" name="price" placeholder="Entrez votre choix"  value="<?php echo $annonce['price']; ?>">
    </div>
    <div class="form-group">
